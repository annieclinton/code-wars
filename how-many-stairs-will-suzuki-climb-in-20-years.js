...
// Some days he climbs more stairs than others depending on the number of students he must train in the morning. He is curious how many stairs might be climbed over the next 20 years and has spent a year marking down his daily progress.
...
function stairsIn20(stairs){
    return 20 * stairs.reduce((acc, c) => acc + c.reduce((acc, c) => acc + c, 0), 0)
  }